...
const sampleProducts = [
  {
    id: 1,
    name: "ALISTIC Essential Tee",
    price: "89 zł",
    description: "Klasyczna koszulka z wysokiej jakości bawełny. Idealna na co dzień i na specjalne okazje. Miękka w dotyku i trwała.",
    size: "S",
    image: "https://images.pexels.com/photos/32278279/pexels-photo-32278279.jpeg",
    vintedUrl: "", // Zostanie wypełnione później
    instagramProfile: "alistic_store" // Twój profil Instagram
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className="text-2xl font-bold text-black tracking-tight">ALISTIC</span>
          </div>
          
          <nav className="hidden md:flex space-x-8">
            <a href="#products" className="text-black hover:text-green-500 font-medium transition-colors">Produkty</a>
            <a href="#about" className="text-black hover:text-green-500 font-medium transition-colors">O nas</a>
            <a href="#contact" className="text-black hover:text-green-500 font-medium transition-colors">Kontakt</a>
          </nav>
...
const PurchaseModal = ({ isOpen, onClose, product }) => {
  ...
  const handleInstagramClick = () => {
    const message = encodeURIComponent(`Cześć! Interesuje mnie koszulka "${product.name}" za ${product.price}. Czy jest dostępna?`);
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-black mb-4">Produkt nie znaleziony</h2>
          <button 
            onClick={() => navigate('/')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              <h4 className="font-semibold text-black mb-2">Informacje o dostawie:</h4>
  ...
  return (
    <section id="about" className="py-12 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-600 leading-relaxed">
          ALISTIC to marka stworzona z pasji do mody i jakości. 
          Oferujemy unikalne koszulki, które łączą nowoczesny design z najwyższą jakością materiałów.
        </p>
      </div>
    </section>
  );
    ...
    <footer className="bg-black text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="flex items-center justify-center mb-4">
          <img src={logoUrl} alt="ALISTIC" className="h-8 w-auto mr-3 filter invert" />
          <span className="text-xl font-bold">ALISTIC</span>
        </div>
        <p className="text-gray-400">© 2025 ALISTIC. Wszystkie prawa zastrzeżone.</p>
      </div>
    </footer>
  );
};
